// import { LocalStorageKeys, LocaleOptions } from "@/types/constants";
import { LocaleOptions, LocalStorageKeys } from "@/constants/storage";
...
export default function useLocale() {
  ...
  const changeLocale = (locale: string) => {
    ...
    if (isLocaleOption(locale)) {
      ...
      localStorage.setItem(LocalStorageKeys.localeKey, locale);
    }
  };
  return {
    currentLocale,
